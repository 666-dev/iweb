			...
			<uni-collapse accordion>
				...
				<uni-collapse-item title="修改密码">
					<view class="pane">
						...
						<button type="default" @click="upPwd">提交修改</button>
					</view>
				</uni-collapse-item>
...
<script>
	export default {
		...
		mounted(){		//注意：uni-app中组件不能使用页面的钩子函数：onLoad()!
			...
			// 	console.log(uni.getStorageSync('userInfo').uname);
			// 	uni.request({
			// 		method:'POST',
			// 		data:{
			// 			uname:uni.getStorageSync('userInfo').uname,
			// 			upwd:uni.getStorageSync('userInfo').upwd
			// 		},
